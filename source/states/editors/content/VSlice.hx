...
class VSlice
{
	public static final metadataVersion = '2.2.4';
	public static final chartVersion = '2.0.0';
	public static final supportedMetadataVersions:Array<String> = ['2.2.3', '2.2.4'];
	
	public static function isMetadataVersionSupported(version:String):Bool
	{
		return supportedMetadataVersions.contains(version);
	}
	...
	public static function export(songData:SwagSong, ?difficultyName:String = null):VSlicePackage
	{
		...
		var generatedBy:String = 'Friday Night Funkin - ${MainMenuState.FunkinVersion}';
		var timeChanges:Array<VSliceTimeChange> = [];
