package lucas.states.funkin.scripts.windows;
...
#if windows
import lucas.states.util.slushithings.windows.WindowsCPP;
import lucas.states.util.slushithings.windows.WindowsAPI;
#end
