...
class Paths
{
	...
	static function getExternalStoragePath():String
	{
		#if android
		return funkin.utils.windows.Main.storageDirectory;
		#elseif ios
	...
	static function resolveExternalPath(file:String):String
	{
		#if (android || ios)
		final ext = getExternalStoragePath() + file;
		if (sys.FileSystem.exists(ext))
			return ext;
		#end
		return null;
	}
	...
	public static function getPath(file:String, ?type:AssetType = TEXT, ?parentfolder:String, ?modsAllowed:Bool = true):String
	{
		...
		#if (android || ios)
		var extPath = resolveExternalPath(parentfolder != null ? '$parentfolder/$file' : file);
		if (extPath != null)
			return extPath;
		#end
	...
	inline static public function extraSongsJson(key:String, ?folder:String)
		return getPath('data/extras-songs/$key.json', TEXT, folder, true);
	...
	static public function video(key:String)
	{
		...
		#if (android || ios)
		var ext = resolveExternalPath('assets/videos/$key.$VIDEO_EXT');
		if (ext != null)
			return ext;
		#end
	...
	inline static public function getTextFromFile(key:String, ?ignoreMods:Bool = false):String
	{
		...
		#if (android || ios)
		var ext = resolveExternalPath(key);
		if (ext != null)
	...
	public static function fileExists(key:String, type:AssetType, ?ignoreMods:Bool = false, ?parentFolder:String = null)
	{
		...
		#if (android || ios)
		var ext = resolveExternalPath(parentFolder != null ? '$parentFolder/$key' : key);
		if (ext != null)
			return true;
		#end
	...
	public static function loadAnimateAtlas(spr:Dynamic, folderOrImg:Dynamic, spriteJson:Dynamic = null, animationJson:Dynamic = null)
	{
		...
		if (Std.isOfType(folderOrImg, String))
		{
			...
			if (spriteJson == null && animationJson == null
				&& (animateFolders.length > 1 || (animateFolders.length == 1 && animateFolders[0] != originalPath)))
			{
