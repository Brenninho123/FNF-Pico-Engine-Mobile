package funkin.data.achievements;

#if ACHIEVEMENTS_ALLOWED
import funkin.data.achievements.AchievementPopup;
...
class Achievements {
	public static function init()
	{
		...
		#end
		#if PICO_ALLOWED
		createAchievement('extra_explorer',		{name: "Extra Menu", description: "You entered the Extra Menu for the first time."});
		#end
	...
	@:allow(funkin.data.achievements.AchievementPopup)
