...
class DiscordClient
{
	...
	public static function changePresence(details:String = 'In the Menus', ?state:String, ?smallImageKey:String, ?hasStartTimestamp:Bool, ?endTimestamp:Float, largeImageKey:String = 'icon')
	{
		...
		presence.largeImageText = 'Engine Version:  + ${lucas.states.funkin.scripts.menus.MainMenuState.PicoVersion} (${lucas.states.funkin.scripts.menus.MainMenuState.FunkinVersion})';
