...
class HScript extends Iris
{
	...
	override function preset() {
		...
		set('PsychCamera', funkin.utils.psych.PsychCamera);
		...
		set('Paths', funkin.data.Paths);
		set('Conductor', funkin.utils.Conductor);
		set('ClientPrefs', funkin.ClientPrefs);
		#if ACHIEVEMENTS_ALLOWED
		set('Achievements', funkin.data.achievements.Achievements);
		#end
		set('Character', funkin.data.characters.Character);
		set('Alphabet', funkin.utils.Alphabet);
		set('Note', funkin.data.notes.Note);
		set('CustomSubstate', funkin.modding.scripting.psychlua.CustomSubstate);
		#if (!flash && sys)
		set('FlxRuntimeShader', flixel.addons.display.FlxRuntimeShader);
		set('ErrorHandledRuntimeShader', funkin.play.shaders.ErrorHandledShader.ErrorHandledRuntimeShader);
		#end
