package funkin.utils.vslice.cutscenes;
...
import funkin.utils.vslice.objects.PicoDopplegangerSprite;
...
class TwoPicos
{
	...
	function cameraPos(char:Character, camOffset:Array<Float>)
	{
		...
		point.x -= char.cameraOffsets[0] - camOffset[0];
		point.y += char.cameraOffsets[1] + camOffset[1];
