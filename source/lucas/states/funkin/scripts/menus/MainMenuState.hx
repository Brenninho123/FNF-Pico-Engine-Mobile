...
{
	public static var PicoVersion:String = '2.26.6 (Pre Release)'; // As Pico Engine Mod Version
	public static var PsychVersion:String = '1.0.4 Customized';
	public static var FunkinVersion:String = '0.8.4'; // V-Slice version of Friday Night Funkin'

	#if mobile
 	public static var PicoVersionMobile:String = '2.3.5'; // mobilie Version of Pico Engine
 	#end
	...
	override function create()
	{
		...
		#if mobile
		var picoVerMobile:FlxText = new FlxText(12, FlxG.height - 24, 0, "Pico Engine Mobile v" + PicoVersionMobile, 12);
		picoVerMobile.scrollFactor.set();
		picoVerMobile.setFormat(Paths.font("vcr.ttf"), 16, FlxColor.GREEN, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(picoVerMobile);
		#end
			...
			if (controls.ACCEPT || (FlxG.mouse.justPressed && allowMouse))
			{
				...
				FlxFlicker.flicker(item, 1, 0.06, false, false, function(flick:FlxFlicker)
				{
					switch (option)
					{
						#if PICO_ALLOWED
						case 'story_mode':
							MusicBeatState.switchState(new lucas.states.funkin.scripts.menus.modes.StoryModeState());
						case 'freeplay':
