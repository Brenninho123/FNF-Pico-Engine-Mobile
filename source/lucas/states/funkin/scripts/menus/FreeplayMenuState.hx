...
class FreeplayMenuState extends MusicBeatState
{
	...
	function weekIsLocked(name:String):Bool
	{
		...
		return (!leWeek.startUnlocked && leWeek.weekBefore.length > 0 && (!lucas.states.funkin.scripts.menus.modes.StoryModeState.weekCompleted.exists(leWeek.weekBefore) || !lucas.states.funkin.scripts.menus.modes.StoryModeState.weekCompleted.get(leWeek.weekBefore)));
	}
