...
class EditorPlayState extends MusicBeatSubstate
{
	...
	function popUpComboFallback():String
	{
		return switch(PlayState.stageUI) {
			...
			default: '${PlayState.uiPrefix}UI/combo${PlayState.uiPostfix}';
		}
	}
	...
	function popUpNumberFallback(digit:Int):String
	{
		return switch(PlayState.stageUI) {
			...
			default: '${PlayState.uiPrefix}UI/num$digit${PlayState.uiPostfix}';
		}
	}
	...
	{
		return ClientPrefs.data.antialiasing && !Note.noteStyleUiIsPixel(assetName, PlayState.isPixelStage);
	}
	...
	private function popUpScore(note:Note = null):Void
	{
		...
		var popupScale:Float = !PlayState.isPixelStage ? 0.7 : PlayState.daPixelZoom * 0.85;
		...
		for (i in 0...separatedScore.length)
		{
			...
			numScore.setGraphicSize(Std.int(numScore.width * noteStyleUiScale(numberUiAsset, !PlayState.isPixelStage ? 0.5 : PlayState.daPixelZoom)));
