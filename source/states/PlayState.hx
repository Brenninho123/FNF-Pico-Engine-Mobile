...
// Pico Enigne
import lucas.states.funkin.util.funkin.stages.StagesPreload; // New Preload Folder for stages
...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		var _songId:String = Paths.formatToSongPath(Song.loadedSongName ?? SONG.song);
		...
		StagesPreload.addstage(curStage); // Mod stages In Pico Engine
	...
	public dynamic function fullComboFunction()
	{
		...
		var marvelouss:Int = ratingsData[4].hits;
