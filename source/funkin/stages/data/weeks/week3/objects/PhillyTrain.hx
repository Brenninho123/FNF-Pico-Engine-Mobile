package funkin.stages.data.weeks.week3.objects;
...
class PhillyTrain extends BGSprite
{
		...
		if (moving)
		{
			...
			if (frameTiming >= 1 / 24)
			{
				if (sound.time >= 4700)
				{
					...
					{
						PlayState.instance.boyfriend.playAnim('hairBlow');
	...
	public function restart():Void
	{
		...
		if(PlayState.instance.gf != null)
		{
			PlayState.instance.boyfriend.danced = false;
			PlayState.instance.boyfriend.playAnim('hairFall');
			PlayState.instance.boyfriend.specialAnim = true;
