...
class ChartConverterState extends MusicBeatState
{
	...
	function changeSel(diff:Int = 0)
	{
		...
		{
			default: 'Converts a VSlice/Base Game chart and meta to a functional chart for Pico Engine.\nPlease note that when using this provide both the chart.json and meta.json';
			case 1: 'Converts a Codename engine chart to a functional chart for Pico Engine.\nPlease note that when using this provide both the chart.json and meta.json';
			case 2: 'Converts a Psych Engine 1.0 chart to a functional chart for Pico Engine.';
		}
